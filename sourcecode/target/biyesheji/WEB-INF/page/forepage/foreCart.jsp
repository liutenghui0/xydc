                    ...
                    <div class="cart-table table-responsive mb-40">
                        ...
                        <c:forEach items="${ois}" var="oi">
                            <tr>
                                ...
                                <c:if test="${cst.status==0}"><td class="pro-price"><span>RMB&nbsp;${oi.product.price}</span></td></c:if>
                                <c:if test="${cst.status==1}"><td class="pro-price"><span>RMB&nbsp;${oi.product.price}</span></td></c:if>
                                <td class="pro-quantity"><div><input type="hidden" id="oiNumber${oi.id}" value="${oi.number}"><span>${oi.number}</span></div></td>
                                <c:if test="${cst.status==0}">
                                    <td class="pro-subtotal"><span id="xiaoji1">RMB&nbsp;${oi.number*oi.product.price}</span></td>
                                </c:if>
                                <c:if test="${cst.status==1}">
                                    <td class="pro-subtotal"><span id="xiaoji08">RMB&nbsp;${oi.number*oi.product.price}</span></td>
                                </c:if>
