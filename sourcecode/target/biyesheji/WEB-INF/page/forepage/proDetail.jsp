                        ...
                        <div class="nav small-image-slider fl3-small-image-slider" role="tablist">
                            <div class="single-small-image img-full">
                                <a data-toggle="tab" id="single-slide-tab-1" href="javascript:;">
                                    <img src="${pageContext.request.contextPath}/assets/images/single-product-slider/6.jpg" class="img-fluid" alt="">
                                </a>
                            </div>
                            <div class="single-small-image img-full">
                                <a data-toggle="tab" id="single-slide-tab-2" href="javascript:;">
                                    <img src="${pageContext.request.contextPath}/assets/images/single-product-slider/7.jpg" class="img-fluid" alt="">
                                </a>
                            </div>
                            <div class="single-small-image img-full">
                                <a data-toggle="tab" id="single-slide-tab-3" href="javascript:;">
                                    <img src="${pageContext.request.contextPath}/assets/images/single-product-slider/8.jpg" class="img-fluid" alt="">
                                </a>
                            </div>
                            <div class="single-small-image img-full">
                                <a data-toggle="tab" id="single-slide-tab-4" href="javascript:;">
                                    <img src="${pageContext.request.contextPath}/assets/images/single-product-slider/9.jpg" alt="">
                                </a>
                            </div>
                            <div class="single-small-image img-full">
                                <a data-toggle="tab" id="single-slide-tab-5" href="javascript:;">
                                    <img src="${pageContext.request.contextPath}/assets/images/single-product-slider/10.jpg" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-6 col-md-6 col-xs-12">
                ...
                <div class="product-feature-details">
                    ...
                    <h2 class="product-price mb-0">
                        <span class="main-price discounted">RMB&nbsp;&nbsp;${product.price+15}</span>
                        <span class="discounted-price"> RMB&nbsp;&nbsp;${product.price}</span>
                    </h2>

                    <p class="product-description mb-20">所有食品已严格把关，无任何食品安全问题，价格公道，食品美味，
                        值得拥有，你还在等什么，感觉给自己点上一份香喷喷的美食犒劳自己吧！
                        <br/><br>卖家承诺：如果有任何食品安全问题，无条件全额退款，并且赠送一张价值199元的代金券
                    </p>
                    ...
                    <div class="fl-product">
                        ...
                        <div class="content">
                            ...
                            <p class="product-price">
                                <span class="main-price discounted">RMB&nbsp;&nbsp;${pf.price+15}</span>
                                <span class="discounted-price">RMB&nbsp;&nbsp;${pf.price}</span>
                            </p>
                        </div>
                    </div>
                    </c:forEach>
               ...
               <%-- <form class="form-horizontal">--%>
                   <div class="loginErrorMessageDiv">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="name" id="name" placeholder="账号" required="required">
                        </div>
                    </div>
                    <!--密码框-->
                    <div class="form-group">
