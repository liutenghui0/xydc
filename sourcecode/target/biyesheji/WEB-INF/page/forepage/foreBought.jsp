                                            ...
                                            <tr>
                                                <td width="55%">
                                                    ...
                                                    <ul class="order_goods_list">
                                                        ...
                                                        <li class="col02"><a href="foreDetailUI?id=${oi.product.id}">${oi.product.name},${oi.product.price}元</a></li>
                                                        <li class="col03">${oi.number}</li>
                                                        <li class="col04">RMB&nbsp;&nbsp;${oi.product.price*oi.number}</li>
                                                        <li class="col04"><a href="javascript:;" onclick="pingjia(${oi.product.id});">评价</a></li>
                                                    </ul>
                                                    </c:forEach>
                                                </td>
                                                <td width="15%">${order.total+10}元</td>
                                                <td width="15%" >
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <textarea class="form-control" name="content" id="contents" placeholder="发表对该商品的评价......" required="required"></textarea>
                    </div>
                </div>
                <!--登陆按钮-->
                <div class="form-group">
