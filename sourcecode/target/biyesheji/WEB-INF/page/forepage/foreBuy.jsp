                            ...
                            <c:forEach items="${ois}" var="orderItem">
                                <tr>
                                    <td class="pro-thumbnail">
                                        <img src="${pageContext.request.contextPath}/${orderItem.product.imageurl}" class="img-fluid" alt="Product">
                                    </td>
                                    <td class="pro-title"><a href="single-product.html">${orderItem.product.name}</a></td>
                                    <c:if test="${cst.status==0}"><td class="pro-price"><span>RMB&nbsp;${orderItem.product.price}</span></td></c:if>
                                    <c:if test="${cst.status==1}"><td class="pro-price"><span>RMB&nbsp;${orderItem.product.price}</span></td></c:if>
                                    <td class="pro-quantity"><div class=""><span>${orderItem.number}</span></div></td>
                                    <c:if test="${cst.status==0}">
                                        <td class="pro-subtotal"><span id="xiaoji1">RMB&nbsp;${orderItem.number*orderItem.product.price}</span></td>
                                    </c:if>
                                    <c:if test="${cst.status==1}">
                                        <td class="pro-subtotal"><span id="xiaoji08">RMB&nbsp;${orderItem.number*orderItem.product.price}</span></td>
                                    </c:if>
                                </tr>
                            </c:forEach>
                            </tbody>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6 mb-60">
                                                    ...
                                                    <div class="checkout-cart-total">
                                                        ...
                                                        <p>小计 <span>RMB&nbsp;${total}</span></p>

                                                        <p>运费 <span>RMB&nbsp;10.00</span></p>

                                                        <h4>总计 <span>RMB&nbsp;${total+10}</span></h4>
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="checkout-payment-method">
                                                        ...
                                                        <div class="single-method">
                                                            ...
                                                            <label for="payment_bank">银行转账</label>
                                                            <p data-method="bank"><input type="text" value="" id="zhanghao" placeholder="请填写银行卡号"/></p>
                                                        </div>
