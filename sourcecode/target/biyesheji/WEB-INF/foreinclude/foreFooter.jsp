                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="address-block">
                        ...
                        <div class="address-text">
                            <ul>
                                <li>地址: 湖北工程学院</li>
                                <li>手机: 18786428429</li>
                                <li>传真: 15926850806</li>
                                <li>电子邮箱: liu1620207158@163.com</li>
                            </ul>
                        </div>
                    ...
                    <div class="widget-block">
                        ...
                        <div class="newsletter-form mb-20">
                            <form id="mc-form" class="mc-form">
                                ...
                                <button type="submit" value="submit">点击订阅</button>
                            </form>
                        </div>
            ...
            <div class="row align-items-center">
                <div class="col-md-6 text-center text-md-left mb-20 mb-md-0">
                    ...
                    <div class="footer-copyright-text">
                        <p>Copyright &copy; 2020 <a href="#">刘腾辉</a></p>
                    </div>
