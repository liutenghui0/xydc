            ...
            <div class="row">
                <div class="col-12 col-lg-6">
                    <div class="header-top-text text-center text-lg-left mb-0 mb-md-15 mb-sm-15">
                        <p><i class="icon ion-md-alarm"></i> 下单后，30分钟内送达,投诉电话  <span class="support-no">: (86) 159 2685 0806</span></p>
                    </div>
                </div>
                <div class="col-12 col-lg-6">
                    ...
                    <div class="header-top-dropdown d-flex justify-content-center justify-content-lg-end">
                        ...
                        <c:if test="${cst==null}">
                            <div class="single-dropdown">
                                <a href="foreLoginUI"><span>登录</span></a>
                            </div>
                            <span class="separator pl-15 pr-15">|</span>
                            <div class="single-dropdown">
                ...
                <div class="col-6 col-lg-2 col-md-6 col-sm-6 order-1 order-lg-1">
                    ...
                    <div class="logo">
                        <a href="/fore/foreIndex">
                            <img src="${pageContext.request.contextPath}/assets/images/logo_2.png" class="img-fluid" alt="">
                        </a>
                    </div>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-7">
                    ...
                    <div class="sticky-logo">
                        <a href="/fore/foreIndex">
                            <img src="${pageContext.request.contextPath}/assets/images/logo_22.png" class="img-fluid" alt="">
                        </a>
                    </div>
                ...
                <div class="col-12 col-lg-3">
                    ...
                    <div class="navigation-search d-none d-lg-block">
                        <form method="post" action="/fore/foreNameLike">
                            <input type="search" placeholder="输入商品关键字......" name="pName">
