                ...
                <div class="col-lg-12">
                    ...
                    <div class="slider-banner-sidebar-three-container">
                        <div class="sidebar-container">
                            ...
                            <!--=======  sidebar  =======-->
                            <div class="sidebar">校园点餐，享受美味，快捷每一天</div>
                            <!--=======  End of sidebar  =======-->
                        </div>
                        <!--=======  banner  =======-->
                        <div class="slider-banner home-four-banner slider-border banner-bg banner-bg-24">
...
<%--												<a href="#" ><i class="icon ion-md-heart-empty"></i></a>--%>
                                            ...
                                            <span class="main-price discounted">
                                                RMB&nbsp;&nbsp;<fmt:formatNumber type="number" value="${product.price+15}" pattern="0.00" maxFractionDigits="2"/>
                                            </span>
                                                    <span class="discounted-price">
                                                RMB&nbsp;&nbsp;<fmt:formatNumber type="number" value="${product.price}" pattern="0.00" maxFractionDigits="2"/>
                                            </span>
                                                </p>

                                                <!-- begain 鼠标放在图片上显示购物车和购买 -->
            ...
            <div class="col-lg-12">
                ...
                <div class="brand-logo-slider-container">
                    ...
                    <div class="single-brand">
                        <a href="#">
                            <img src="${pageContext.request.contextPath}/assets/images/brands/8.jpg" class="img-fluid" alt="">
                        </a>
                    </div>
                    ...
                    <div class="single-brand">
                        <a href="#">
                            <img src="${pageContext.request.contextPath}/assets/images/brands/9.jpg" class="img-fluid" alt="">
                        </a>
                    </div>
                    ...
                    <div class="single-brand">
                        <a href="#">
                            <img src="${pageContext.request.contextPath}/assets/images/brands/10.jpg" class="img-fluid" alt="">
                        </a>
                    </div>
                    ...
                    <div class="single-brand">
                        <a href="#">
                            <img src="${pageContext.request.contextPath}/assets/images/brands/11.jpg" class="img-fluid" alt="">
                        </a>
                    </div>
                        ...
                        <div class="product-feature-details">
                            ...
                            <div class="social-share-buttons">
                                ...
                                <ul>
                                    ...
                                    <li><a class="pinterest" href="#"><i class="fa fa-youtube"></i></a></li>
                                </ul>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    function Values(id,name,price,imageUrl,miaoshu) {
        ...
        $("#proPrice").html('RMB '+price);
        var proPrice1 = 15;
        $("#proPrice1").html('RMB '+proPrice1);
